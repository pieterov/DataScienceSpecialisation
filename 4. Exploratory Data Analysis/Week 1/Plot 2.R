# PLOT 2 - Individual household electric power consumption Data Set
...
# Make plot 2.
png("plot2.png")
plot(fdata2$DateTime, fdata2$Global_active_power, xlab="", ylab="Global Active Power (kilowatt)", type="n")
