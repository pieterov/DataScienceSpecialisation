# PLOT 4 - Individual household electric power consumption Data Set
...
# Top Left
plot(fdata2$DateTime, fdata2$Global_active_power, xlab="", ylab="Global Active Power", type="n")
lines(fdata2$DateTime, fdata2$Global_active_power, type="l")

# Top Right
plot(fdata2$DateTime, fdata2$Voltage, xlab="datetime", ylab="Voltage", type="n")
lines(fdata2$DateTime, fdata2$Voltage, type="l")
...
# Bottom Right
plot(fdata2$DateTime, fdata2$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="n")
lines(fdata2$DateTime, fdata2$Global_reactive_power, type="l")
