...
# ====================================================================================================
# PLOT2 - Compare 'Average Covered Charges' to 'Average Total Payments' by Medical Condition and State
# ====================================================================================================
...
# Determine list of medical conditions (100) and states (51) 
...
# Initialise matrices that will be filled with number of obs. per subset, intercept and slop
